...
#include "robots/robot_aliengo_sim.h"
namespace Quadruped {
    AliengoSim::AliengoSim(ros::NodeHandle &nhIn, ros::NodeHandle &privateNhIn, std::string configFilePath)
        : nh(nhIn), privateNh(privateNhIn)
    {
        ...
        imuSub = nh.subscribe("/trunk_imu", 1, &AliengoSim::ImuCallback, this);
        jointStateSub[0] = nh.subscribe("aliengo_gazebo/FR_hip_controller/state", 1, &AliengoSim::FRhipCallback, this);
        jointStateSub[1] = nh.subscribe("aliengo_gazebo/FR_thigh_controller/state", 1, &AliengoSim::FRthighCallback, this);
        jointStateSub[2] = nh.subscribe("aliengo_gazebo/FR_calf_controller/state", 1, &AliengoSim::FRcalfCallback, this);
        jointStateSub[3] = nh.subscribe("aliengo_gazebo/FL_hip_controller/state", 1, &AliengoSim::FLhipCallback, this);
        jointStateSub[4] = nh.subscribe("aliengo_gazebo/FL_thigh_controller/state", 1, &AliengoSim::FLthighCallback, this);
        jointStateSub[5] = nh.subscribe("aliengo_gazebo/FL_calf_controller/state", 1, &AliengoSim::FLcalfCallback, this);
        jointStateSub[6] = nh.subscribe("aliengo_gazebo/RR_hip_controller/state", 1, &AliengoSim::RRhipCallback, this);
        jointStateSub[7] = nh.subscribe("aliengo_gazebo/RR_thigh_controller/state", 1, &AliengoSim::RRthighCallback, this);
        jointStateSub[8] = nh.subscribe("aliengo_gazebo/RR_calf_controller/state", 1, &AliengoSim::RRcalfCallback, this);
        jointStateSub[9] = nh.subscribe("aliengo_gazebo/RL_hip_controller/state", 1, &AliengoSim::RLhipCallback, this);
        jointStateSub[10] = nh.subscribe("aliengo_gazebo/RL_thigh_controller/state", 1, &AliengoSim::RLthighCallback, this);
        jointStateSub[11] = nh.subscribe("aliengo_gazebo/RL_calf_controller/state", 1, &AliengoSim::RLcalfCallback, this);
        footForceSub[0] = nh.subscribe("/visual/FR_foot_contact/the_force", 1, &AliengoSim::FRfootCallback, this);
        footForceSub[1] = nh.subscribe("/visual/FL_foot_contact/the_force", 1, &AliengoSim::FLfootCallback, this);
        footForceSub[2] = nh.subscribe("/visual/RR_foot_contact/the_force", 1, &AliengoSim::RRfootCallback, this);
        footForceSub[3] = nh.subscribe("/visual/RL_foot_contact/the_force", 1, &AliengoSim::RLfootCallback, this);
    ...
    void AliengoSim::ImuCallback(const sensor_msgs::Imu &msg)
    {
    ...
    void AliengoSim::FRhipCallback(const unitree_legged_msgs::MotorState &msg)
    {
    ...
    void AliengoSim::FRthighCallback(const unitree_legged_msgs::MotorState &msg)
    {
    ...
    void AliengoSim::FRcalfCallback(const unitree_legged_msgs::MotorState &msg)
    {
    ...
    void AliengoSim::FLhipCallback(const unitree_legged_msgs::MotorState &msg)
    {
    ...
    void AliengoSim::FLthighCallback(const unitree_legged_msgs::MotorState &msg)
    {
    ...
    void AliengoSim::FLcalfCallback(const unitree_legged_msgs::MotorState &msg)
    {
    ...
    void AliengoSim::RRhipCallback(const unitree_legged_msgs::MotorState &msg)
    {
    ...
    void AliengoSim::RRthighCallback(const unitree_legged_msgs::MotorState &msg)
    {
    ...
    void AliengoSim::RRcalfCallback(const unitree_legged_msgs::MotorState &msg)
    {
    ...
    void AliengoSim::RLhipCallback(const unitree_legged_msgs::MotorState &msg)
    {
    ...
    void AliengoSim::RLthighCallback(const unitree_legged_msgs::MotorState &msg)
    {
    ...
    void AliengoSim::RLcalfCallback(const unitree_legged_msgs::MotorState &msg)
    {
    ...
    void AliengoSim::FRfootCallback(const geometry_msgs::WrenchStamped &msg)
    {
    ...
    void AliengoSim::FLfootCallback(const geometry_msgs::WrenchStamped &msg)
    {
    ...
    void AliengoSim::RRfootCallback(const geometry_msgs::WrenchStamped &msg)
    {
    ...
    void AliengoSim::RLfootCallback(const geometry_msgs::WrenchStamped &msg)
    {
    ...
    void AliengoSim::SendCommand(const std::array<float, 60> motorcmd)
    {
    ...
    void AliengoSim::ReceiveObservation()
    {
        // ros::spinOnce();
        // usleep(1000);
    ...
    void AliengoSim::ApplyAction(const Eigen::MatrixXf &motorCommands,
    ...
    void AliengoSim::ApplyAction(const std::vector<MotorCommand> &motorCommands,
                            MotorMode motorControlMode)
    {
        // std::cout << "apply:\n" << motorCommands << std::endl;
        std::array<float, 60> motorCommandsArray = {0};
    ...
    void AliengoSim::Step(const Eigen::MatrixXf &action,
                     MotorMode motorControlMode)
    {
        ReceiveObservation();
