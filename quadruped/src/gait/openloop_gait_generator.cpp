...
namespace Quadruped {
    ...
    */
    ...
    {  
        ...
        lastTime = currentTime;
        // std::cout << "normalizedPhase " << normalizedPhase.transpose() << std::endl;
        // std::cout << "desiredLegState " << desiredLegState.transpose() << std::endl;
        // std::cout << "curLegState " << curLegState.transpose() << std::endl;
        // std::cout << "legState " << legState.transpose() << std::endl;
        // std::cout << "footContact " << robot->GetFootContacts().transpose() << std::endl;
        // std::cout << "allowSwitch " << allowSwitchLegState.transpose() << std::endl;
    }

    void OpenloopGaitGenerator::Schedule(float currentTime)
    {
