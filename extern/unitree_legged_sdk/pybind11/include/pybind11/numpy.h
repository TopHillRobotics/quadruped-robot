...
#define PYBIND11_MAP_LIST_NEXT1(tests, next) \
    PYBIND11_EVAL0 (PYBIND11_MAP_NEXT0 (tests, PYBIND11_MAP_COMMA next, 0))
#else
#define PYBIND11_MAP_LIST_NEXT1(tests, next) \
    PYBIND11_MAP_NEXT0 (tests, PYBIND11_MAP_COMMA next, 0)
#endif
#define PYBIND11_MAP_LIST_NEXT(tests, next) \
    PYBIND11_MAP_LIST_NEXT1 (PYBIND11_MAP_GET_END tests, next)
...
#define PYBIND11_MAP2_LIST_NEXT1(tests, next) \
    PYBIND11_EVAL0 (PYBIND11_MAP_NEXT0 (tests, PYBIND11_MAP_COMMA next, 0))
#else
#define PYBIND11_MAP2_LIST_NEXT1(tests, next) \
    PYBIND11_MAP_NEXT0 (tests, PYBIND11_MAP_COMMA next, 0)
#endif
#define PYBIND11_MAP2_LIST_NEXT(tests, next) \
    PYBIND11_MAP2_LIST_NEXT1 (PYBIND11_MAP_GET_END tests, next)
